...
var addNewItemHelper = {
    addNewItem: function (parent){
        ...
        var addNewItemInfoURLInput = this.generateContentSectionInputField('URL','text');
        ...
        var addNewItemInfoNameInput = this.generateContentSectionInputField('NameInput','text');
        ...
        addNewItemInfoUserName.append(this.generateContentSectionInputField('UserNameInput','text'));
        ...
        var addNewPasswordInputSpan = this.generateContentSectionInputField('PasswordInput','password');
